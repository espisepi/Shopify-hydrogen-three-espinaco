...
export default function ProductHandle() {
  // useLoaderData devuelve los datos que devuelve el metodo loader definido en este archivo
...
interface Media {
  ...
  image: {
    id: string;
    altText: string;
    // Agrega aquí cualquier otra propiedad de la imagen que pueda haber
  };
  // Agrega aquí cualquier otra propiedad de media que pueda haber
}
...
function ProductGallery({media}: ProductGalleryProps): ReactElement | null {
  if (!media.length) {
    return null;
  }
    ...
    >
      {media.map((med, i) => {
        ...
        return (
          ...
          >
            {/* Asumiendo que `MediaFile` es un componente de React válido */}
            <MediaFile
              tabIndex={0}
...
// Utilities to debug component to see product data
